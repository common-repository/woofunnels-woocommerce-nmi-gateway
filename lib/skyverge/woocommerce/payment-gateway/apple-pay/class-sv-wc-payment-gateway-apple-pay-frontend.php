...
if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_2_1\\SV_WC_Payment_Gateway_Apple_Pay_Frontend' ) ) :
...
class SV_WC_Payment_Gateway_Apple_Pay_Frontend {
	...
	public function enqueue_scripts() {
		...
		$params = apply_filters( 'sv_wc_apple_pay_js_handler_params', array(
			...
			'generic_error'            => __( 'An error occurred, please retry or try an alternate form of payment', 'woocommerce-plugin-framework' ),
		) );
